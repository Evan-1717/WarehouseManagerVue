<template>
    <div style="height:100%">
        <div style="margin-bottom: 5px;">
            ...
            <el-button type="primary" style="margin-left: 5px;" @click="exportExcelTopNovel">导出最热小说</el-button>
        ...
        <el-table :data="tableData" :summary-method="getSummaries"  show-summary
            ...
            <el-table-column prop="heiyanexpend" label="黑岩消耗" width="100" :sortable="true"></el-table-column>
            <el-table-column prop="heiyanrecharge" label="黑岩充值" width="100" :sortable="true"></el-table-column>
            <el-table-column prop="heiyanroi" label="黑岩ROI" width="100" :sortable="true"></el-table-column>
            <el-table-column prop="heiyanmargin" label="黑岩盈亏" width="100" :sortable="true"></el-table-column>
            <el-table-column prop="heiyanprofit" label="黑岩毛利" width="100" :sortable="true" v-if="user.roleId!=2"></el-table-column>

            <el-table-column prop="fanqieexpend" label="番茄消耗" width="100" :sortable="true"></el-table-column>
            <el-table-column prop="fanqierecharge" label="番茄充值" width="100" :sortable="true"></el-table-column>
            <el-table-column prop="fanqieroi" label="番茄ROI" width="100" :sortable="true"></el-table-column>
            <el-table-column prop="fanqiemargin" label="番茄盈亏" width="100" :sortable="true"></el-table-column>
            <el-table-column prop="fanqieprofit" label="番茄毛利" width="100" :sortable="true" v-if="user.roleId!=2"></el-table-column>

            <el-table-column prop="qimaoexpend" label="七猫消耗" width="100" :sortable="true"></el-table-column>
            <el-table-column prop="qimaorecharge" label="七猫充值" width="100" :sortable="true"></el-table-column>
            <el-table-column prop="qimaoroi" label="七猫ROI" width="100" :sortable="true"></el-table-column>
            <el-table-column prop="qimaomargin" label="七猫盈亏" width="100" :sortable="true"></el-table-column>
            <el-table-column prop="qimaoprofit" label="七猫毛利" width="100" :sortable="true" v-if="user.roleId!=2"></el-table-column>
        ...
        <el-dialog
            ...
            <el-form ref="form" :rules="rules" :model="form" label-width="140px">
                ...
                <el-col :span="12">
                    <el-form-item label="黑岩消耗" prop="heiyanexpend">
                        <el-input-number v-model="form.heiyanexpend" :precision="2" :step="0.01" :min="0.00"></el-input-number>
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item label="黑岩充值" prop="heiyanrecharge">
                        <el-input-number v-model="form.heiyanrecharge" :precision="2" :step="0.01" :min="0.00"></el-input-number>
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item label="番茄消耗" prop="fanqieexpend">
                        <el-input-number v-model="form.fanqieexpend" :precision="2" :step="0.01" :min="0.00"></el-input-number>
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item label="番茄充值" prop="fanqierecharge">
                        <el-input-number v-model="form.fanqierecharge" :precision="2" :step="0.01" :min="0.00"></el-input-number>
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item label="七猫消耗" prop="qimaoexpend">
                        <el-input-number v-model="form.qimaoexpend" :precision="2" :step="0.01" :min="0.00"></el-input-number>
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item label="七猫充值" prop="qimaorecharge">
                        <el-input-number v-model="form.qimaorecharge" :precision="2" :step="0.01" :min="0.00"></el-input-number>
                    </el-form-item>
                </el-col>
            </el-form>
    ...
    export default {
        ...
        methods:{
            ...
            getSummaries(param){
                ...
                var heiyanexpendSum = 0;
                var heiyanrechargeSum = 0;
                var heiyanmarginSum = 0;
                var heiyanprofitSum = 0;

                var fanqieexpendSum = 0;
                var fanqierechargeSum = 0;
                var fanqiemarginSum = 0;
                var fanqieprofitSum = 0;

                var qimaoexpendSum = 0;
                var qimaorechargeSum = 0;
                var qimaomarginSum = 0;
                var qimaoprofitSum = 0;
                var zongmarginSum = 0;
                var zongprofitSum = 0;
                for (var val of data) {
                    ...
                    heiyanexpendSum += val.heiyanexpend;
                    heiyanrechargeSum += val.heiyanrecharge;
                    heiyanmarginSum += val.heiyanmargin;
                    heiyanprofitSum += val.heiyanprofit;

                    fanqieexpendSum += val.fanqieexpend;
                    fanqierechargeSum += val.fanqierecharge;
                    fanqiemarginSum += val.fanqiemargin;
                    fanqieprofitSum += val.fanqieprofit;

                    qimaoexpendSum += val.qimaoexpend;
                    qimaorechargeSum += val.qimaorecharge;
                    qimaomarginSum += val.qimaomargin;
                    qimaoprofitSum += val.qimaoprofit;
                ...
                columns.forEach((column, index) => {
                    if (this.user.roleId==2) {
                        if (index === 0) {
                            ...
                            sums[index] = this.fixed2(heiyanexpendSum);
                        } else if (index === 8) {
                            sums[index] = this.fixed2(heiyanrechargeSum);
                        }else if (index === 9) {
                            sums[index] = this.fixed(heiyanrechargeSum / heiyanexpendSum * 1.045);
                        } else if (index === 10) {
                            sums[index] = this.fixed2(heiyanmarginSum);
                        } else if (index === 11) {
                            sums[index] = this.fixed2(fanqieexpendSum);
                        } else if (index === 12) {
                            sums[index] = this.fixed2(fanqierechargeSum);
                        }else if (index === 13) {
                            sums[index] = this.fixed(fanqierechargeSum / fanqieexpendSum * 1.045);
                        } else if (index === 14) {
                            sums[index] = this.fixed2(fanqiemarginSum);
                        } else if (index === 15) {
                            sums[index] = this.fixed2(qimaoexpendSum);
                        } else if (index === 16) {
                            sums[index] = this.fixed2(qimaorechargeSum);
                        }else if (index === 17) {
                            sums[index] = this.fixed(qimaorechargeSum / qimaoexpendSum * 1.045);
                        } else if (index === 18) {
                            sums[index] = this.fixed2(qimaomarginSum);
                        }  else if (index === 19) {
                            sums[index] = this.fixed((dianzhongrechargeSum + heiyanrechargeSum + fanqierechargeSum + qimaorechargeSum)
                                / (dianzhongexpendSum + heiyanexpendSum + fanqieexpendSum + qimaoexpendSum) * 1.045);
                        } else if (index === 20) {
                        ...
                        if (index === 0) {
                            ...
                            sums[index] = this.fixed2(heiyanprofitSum);
                        }  else if (index === 17) {
                            sums[index] = this.fixed2(fanqieexpendSum);
                        } else if (index === 18) {
                            sums[index] = this.fixed2(fanqierechargeSum);
                            ...
                            sums[index] = this.fixed2(fanqieprofitSum);
                        } else if (index === 22) {
                            sums[index] = this.fixed2(qimaoexpendSum);
                        } else if (index === 23) {
                            sums[index] = this.fixed2(qimaorechargeSum);
                            ...
                            sums[index] = this.fixed2(qimaoprofitSum);
                        } else if (index === 27) {
                            sums[index] = this.fixed2(dianzhongexpendSum + heiyanexpendSum + fanqierechargeSum + qimaorechargeSum);
                        } else if (index === 28) {
                            sums[index] = this.fixed((dianzhongrechargeSum + heiyanrechargeSum + fanqierechargeSum + qimaorechargeSum)
                                / (dianzhongexpendSum + heiyanexpendSum + fanqieexpendSum + qimaoexpendSum) * 1.045);
                        } else if (index === 29) {
            ...
            cell_style({columnIndex}){
                if (this.user.roleId==2) {
                    ...
                    } else if (columnIndex == 19 || columnIndex == 20) {
                        return 'background:rgb(207,200,221);'
                    } else{
                    ...
                    if (columnIndex == 7 ||columnIndex == 8 || columnIndex == 9 || columnIndex == 10 || columnIndex == 11) {
                        ...
                        return 'background:rgb(239,147,18);'
                    } else if (columnIndex == 27 ||columnIndex == 28 ||columnIndex == 29 || columnIndex == 30) {
            ...
            del(id){
                this.$axios.get(this.$httpUrl+'/novel/del?id='+id).then(res=>res.data).then(res=>{
                    if(res.code==200){
            ...
            dealRoi(date){
                let heiyanProfitRat = 0;
                if (new Date(date).getTime() >= new Date("2025-02-03").getTime()) {
                    heiyanProfitRat = 0.92;
                } else {
                    heiyanProfitRat = 0.90;
                }

                if (this.form.dianzhongexpend) {
                    this.form.dianzhongroi = this.fixed(this.form.dianzhongrecharge/this.form.dianzhongexpend * 1.02);
                    this.form.dianzhongmargin = this.fixed2(this.form.dianzhongrecharge * 0.85 - this.form.dianzhongexpend / 1.02);
                    this.form.dianzhongprofit = this.fixed2(this.form.dianzhongrecharge * 0.9 - this.form.dianzhongexpend / 1.02);
                } else {
                    this.form.dianzhongroi = 0;
                    this.form.dianzhongmargin = 0;
                    this.form.dianzhongprofit = 0;
                }
                if (this.form.heiyanexpend) {
                    this.form.heiyanroi = this.fixed(this.form.heiyanrecharge/this.form.heiyanexpend * 1.02);
                    this.form.heiyanmargin = this.fixed2(this.form.heiyanrecharge * 0.85 - this.form.heiyanexpend / 1.02);
                    this.form.heiyanprofit = this.fixed2(this.form.heiyanrecharge * heiyanProfitRat - this.form.heiyanexpend / 1.02);
                } else {
                    this.form.heiyanroi = 0;
                    this.form.heiyanmargin = 0;
                    this.form.heiyanprofit = 0;
                }
                if (this.form.fanqieexpend) {
                    this.form.fanqieroi = this.fixed(this.form.fanqierecharge/this.form.fanqieexpend * 1.02);
                    this.form.fanqiemargin = this.fixed2(this.form.fanqierecharge * 0.85 - this.form.fanqieexpend / 1.02);
                    this.form.fanqieprofit = this.fixed2(this.form.fanqierecharge * 0.9 - this.form.fanqieexpend / 1.02);
                } else {
                    this.form.fanqieroi = 0;
                    this.form.fanqiemargin = 0;
                    this.form.fanqieprofit = 0;
                }
                if (this.form.qimaoexpend) {
                    this.form.qimaoroi = this.fixed(this.form.qimaorecharge/this.form.qimaoexpend * 1.02);
                    this.form.qimaomargin = this.fixed2(this.form.qimaorecharge * 0.85 - this.form.qimaoexpend / 1.02);
                    this.form.qimaoprofit = this.fixed2(this.form.qimaorecharge * 0.9 - this.form.qimaoexpend / 1.02);
                } else {
                    this.form.qimaoroi = 0;
                    this.form.qimaomargin = 0;
                    this.form.qimaoprofit = 0;
                }

                if ((this.form.dianzhongexpend + this.form.heiyanexpend + this.form.fanqieexpend + this.form.qimaoexpend) != 0) {
                    this.form.zongroi = this.fixed((this.form.dianzhongrecharge + + this.form.heiyanrecharge + this.form.fanqierecharge + this.form.qimaorecharge)
                        /(this.form.dianzhongexpend + this.form.heiyanexpend + this.form.fanqieexpend + this.form.qimaoexpend) * 1.02)
                    this.form.zongmargin = this.fixed2((this.form.dianzhongrecharge * 0.85 + this.form.heiyanrecharge * 0.85  + this.form.fanqierecharge * 0.85 + this.form.qimaorecharge * 0.85)
                        - (this.form.dianzhongexpend + this.form.heiyanexpend + this.form.fanqieexpend + this.form.qimaoexpend) / 1.02)
                    this.form.zongprofit = this.fixed2((this.form.dianzhongrecharge * 0.9 + this.form.heiyanrecharge * heiyanProfitRat + this.form.fanqierecharge * 0.9 + this.form.qimaorecharge * 0.9)
                        - (this.form.dianzhongexpend + this.form.heiyanexpend + this.form.fanqieexpend + this.form.qimaoexpend) / 1.02)
                } else {
                    this.form.zongroi = 0;
                ...
                this.form.zongexpend = this.form.dianzhongexpend + this.form.heiyanexpend + this.form.fanqieexpend + this.form.qimaoexpend;
            },
            doSave(){
                this.form.time=this.currentDate();
                this.form.creater = this.user.name;
                this.$axios.post(this.$httpUrl+'/novel/checkrecord',this.form).then(res=>res.data).then(res=>{
                    if(res.data.length==0){
                        this.dealRoi(this.form.date);
                        this.$axios.post(this.$httpUrl+'/novel/save',this.form).then(res=>res.data).then(res=>{
                            if(res.code==200){
                                this.$message({
                                    message: '操作成功！',
                                    type: 'success'
            ...
            exportExcelTopNovel(){
                ...
                this.$confirm('确定导出？','提示',{
                    ...
                    this.$axios.request({
                        url:this.$httpUrl.replace('8002', '8003') + '/novel/exporttopnovel',
                        method:'post',
                        data: {
                            date1:this.form1.date1
                        },
                        ...
                        const link = document.createElement('a');
                        link.href = url;
                        link.setAttribute('download','最热小说' + new Date().getTime() + '.xlsx');
                        document.body.appendChild(link);
                        link.click();
                        window.URL.revokeObjectURL(URL);
                    }).catch(() => {
            ...
            doMod(){
                ...
                this.$axios.post(this.$httpUrl+'/novel/update',this.form).then(res=>res.data).then(res=>{
                    if(res.code==200){
            ...
            loadPost(){
                this.$axios.post(this.$httpUrl+'/novel/listPage',{
